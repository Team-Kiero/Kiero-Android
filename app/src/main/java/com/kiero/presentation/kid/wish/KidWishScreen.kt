...
import com.kiero.presentation.kid.wish.component.KidWishMissionItem
import com.kiero.presentation.kid.wish.component.KidWishMissionTitle
...
private fun KidWishScreen(
    ...
    LazyColumn(
        ...
        KidWishState.FAKE.forEach { section ->
            item {
                KidWishMissionTitle(
